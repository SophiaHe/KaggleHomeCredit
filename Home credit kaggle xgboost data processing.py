# -*- coding: utf-8 -*-
"""
Created on Thu Jun 21 12:11:17 2018
...
one_hot_df = pd.concat([data,test]) # merge train and test
...
# (active, closed, DPD0-30,… [C means closed, X means status unknown, 0 means no DPD, 
# 1 means maximal did during month between 1-30, 2 means DPD 31-60,… 
